    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="bg-white/60 border border-charcoal/5 rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-xs font-sans uppercase tracking-[0.1em] text-charcoal/30 hover:text-sage transition-colors"
          >
            + Add Entry
          </button>
        </div>
      ...
      <div className="flex items-center gap-4">
        <button
          type="submit"
          disabled={saving}
          className="px-8 py-3 bg-charcoal text-cream font-sans text-xs tracking-[0.1em] uppercase rounded-lg hover:bg-sage transition-colors disabled:opacity-50"
        >
