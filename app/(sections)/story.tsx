...
const stories = [
  {
    ...
    description:
      ...
      "Teman sekelas dan teman les yang bersaing untuk mendapatkan ranking 1, " +
  ...
  },
  {
    title: "2022",
    description:
      "Hilang kontak, life happens. " +
      "Riza mengucapkan selamat wisuda kepada Dinnar melalui reply story instagram yang selanjutnya menjadi awal perjalanan mereka kembali dipertemukan. " +
  ...
  },
  {
    title: "2025",
    description:
      "Walaupun sempat dipisahkan jarak 782 km selama 1 tahun, hubungan terus bertumbuh dan merekah. Ketulusan di dalam hubungan yang semakin menguat," +
